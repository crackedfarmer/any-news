NOTE:
  1. PreToolUse hooks from plugins DO work — the hook fired and the script executed                                                                                                                                                                                                                                                                                                                                                     
  2. Hooks are snapshotted at startup — our mid-session changes earlier never took effect, which is why our previous tests failed                                                                                                                                                                                                                                                                                                         
  3. Command-type PreToolUse hooks don't show a "success" system reminder — unlike SessionStart and UserPromptSubmit, PreToolUse command hooks fire silently (no PreToolUse hook success: Success message appears in the conversation)                                                                                                                                                                                                    
